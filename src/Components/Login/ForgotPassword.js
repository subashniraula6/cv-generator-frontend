  ...
  return (
    <div className='loginPage'>   
        {!sentEmail ? (<div style={loginContainer}>
            ...
            <div style={{fontSize:'18px', color:'gray',fontWeight:'600',textTransform:'uppercase',textAlign:"center"}}>Copyright © 2023 <img src='logo-kneg.png'width='15px' alt='KNEG'/></div>
        </div>):
        (
