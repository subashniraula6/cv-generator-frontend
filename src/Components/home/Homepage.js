  ...
  return (
    <div style={{position:'relative'}}>
        ...
        <main style={{width:'90%',margin:'150px auto 0px auto'}}>
            <div className='highlightImageContainer' style={{display:'flex',justifyContent:'center'}}>
                <div style={{width: '150px',padding: '20px',borderRadius:'20px',boxShadow:'rgb(0 0 0 / 14%) 0px 0px 8px 4px'}}>
                    <img src="logo-kneg.png" style={{height:'100%',width:'100%'}}alt="KNEG" />
                </div>
            </div>
            ...
            <div className='contentContainer'>
                ...
                <div className="grid-container">
                    <div className="grid-item"><div style={{display:'flex',alignItems:'center',height:'100%'}}><img src="logo-kneg.png" width="55px" alt="KNEG" /> Kneg</div></div>
                    <div className="grid-item"><div style={{display:'flex',alignItems:'center'}}><img src="logo-kneg-long.jpg" width="250px" alt="KNEG" /></div></div>
                    <div className="grid-item"><div style={{display:'flex',alignItems:'center',height:'100%'}}><img src="logo-kneg-bw.png" width="155px" alt="KNEG" /></div></div>
                    <div className="grid-item"><div style={{display:'flex',alignItems:'center'}}><img src="logo-kneg-long.jpg" width="250px" alt="KNEG" /></div></div>
                    <div className="grid-item"><div style={{display:'flex',alignItems:'center',height:'100%'}}><img src="logo-kneg-bw.png" width="155px" alt="KNEG" /></div></div>
                    <div className="grid-item"><div style={{display:'flex',alignItems:'center'}}><img src="logo-kneg.png" width="55px" alt="KNEG" /> Kneg</div></div>
                </div>
            </div>
            <div className='contentContainer'>
            ...
            <div className='contentContainer'>
                ...
                <div className="contactFormContainer">
                    <div className="contactForm">
                        ...
                        <div className="contactUsBtn" style={{margin:'20px 0px'}}>Send Message</div>
                    </div>
